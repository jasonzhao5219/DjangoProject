...
class UserManager(models.Manager):
    ...
    def addUser(self, postData):
        ...
        newuser = User.objects.create(first_name = postData['first_name'], last_name = postData['last_name'], email = postData['email'], username = postData['username'], date = postData['dob'], password = postData['password'])
        return newuser
    ...
    def validateLogin(self, postData):
        ...
        try: 
            ...
            #return False
        #else:
        if  not retrieved_pass==input_password:
            return False
        else:
            try:
